...
import { AdminTalentInvite } from "@/components/admin-talent-invite";
    ...
    <main className="min-h-screen bg-[#f5f3ee] text-[#171713]">
      <div className="mx-auto max-w-[1440px] px-5 py-8 md:px-10 md:py-10">
        <header className="flex flex-col gap-5 border-b border-black/10 pb-7 md:flex-row md:items-end md:justify-between">
          <div><p className="eyebrow mb-3">Nusantara Star Internal</p><h1 className="text-3xl font-semibold tracking-[-0.03em] md:text-5xl">Dasbor Admin</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-black/60 md:text-base">Brief → pencocokan / permintaan talent langsung → ketersediaan → proposal → kesepakatan → booking terjamin.</p></div>
          <div className="w-fit border border-black/10 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-black/60">Akses internal terverifikasi</div>
        </header>
