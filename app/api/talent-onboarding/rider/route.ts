...
export async function PATCH(request:Request){
 ...
 try{
  ...
  const s=client();const{data:asset,error}=await s.from("talent_assets").select("id,storage_key,size_bytes,provider,asset_type,mime_type,original_filename").eq("id",assetId).eq("talent_id",talentId).maybeSingle();
